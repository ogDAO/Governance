...
describe("TestOGDToken", function() {
  beforeEach("Setup", async function() {
    ...
    setup2.push(ogdToken.setPermission(data.owner, 1, true, 0));
    ...
    setup3.push(ogdToken.mint(data.user1, ogdTokens.toFixed(0)));
    setup3.push(ogdToken.mint(data.user2, ogdTokens.toFixed(0)));
    setup3.push(ogdToken.mint(data.user3, ogdTokens.toFixed(0)));
  ...
  it("Standard Workflow #1", async function() {
    const [ogdToken, fee0Token, fee1Token, fee2Token] = [data.ogdToken, data.fee0Token, data.fee1Token, data.fee2Token];
    const [user1Signer, user2Signer, user3Signer] = [data.user1Signer, data.user2Signer, data.user3Signer];
    ...
    var test2 = [];
    test2.push(ogdToken.connect(user2Signer).transfer(data.user2, "1"));
    ...
    var test3 = [];
    test3.push(ogdToken.connect(user1Signer).withdrawDividends());
    test3.push(ogdToken.connect(user2Signer).withdrawDividends());
    test3.push(ogdToken.connect(user3Signer).withdrawDividends());
    ...
    var test6 = [];
    test6.push(ogdToken.connect(user1Signer).withdrawDividends());
    test6.push(ogdToken.connect(user2Signer).withdrawDividends());
    test6.push(ogdToken.connect(user3Signer).withdrawDividends());
    ...
    var test7 = [];
    test7.push(ogdToken.connect(user2Signer).transfer(data.user3, new BigNumber("0.123456789123456789").shiftedBy(18).toFixed(0)));
