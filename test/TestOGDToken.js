...
describe("TestOGDToken", function() {
  ...
  it("Standard Workflow", async function() {
    ...
    var setup1 = [];
    setup1.push(OGDToken.deploy("OGD", "Optino Governance Dividend", 18, myData.owner, new BigNumber("0").shiftedBy(18).toFixed(0)));
    setup1.push(TestToken.deploy("FEE0", "Fee0", 18, myData.owner, new BigNumber("10000").shiftedBy(18).toFixed(0)));
    setup1.push(TestToken.deploy("FEE1", "Fee1", 18, myData.owner, new BigNumber("10000").shiftedBy(18).toFixed(0)));
    setup1.push(TestToken.deploy("FEE2", "Fee2", 18, myData.owner, new BigNumber("10000").shiftedBy(18).toFixed(0)));
    ...
    setup2.push(ogdToken.setPermission(myData.owner, 1, true, 0));
    ...
    setup3.push(ogdToken.mint(myData.user1, ogdTokens.toFixed(0)));
    setup3.push(ogdToken.mint(myData.user2, ogdTokens.toFixed(0)));
    setup3.push(ogdToken.mint(myData.user3, ogdTokens.toFixed(0)));
    setup3.push(fee0Token.approve(ogdToken.address, approveFee0Tokens.toFixed(0)));
    setup3.push(fee1Token.approve(ogdToken.address, approveFee1Tokens.toFixed(0)));
    setup3.push(fee2Token.approve(ogdToken.address, approveFee2Tokens.toFixed(0)));
    ...
    test1.push(ogdToken.depositDividend(fee0Token.address, depositFee0Tokens.toFixed(0)));
    test1.push(ogdToken.depositDividend(ZERO_ADDRESS, depositFeeETH.toFixed(0), { value: depositFeeETH.toFixed(0) }));
    ...
    var test2 = [];
    test2.push(ogdToken.connect(myData.user2Signer).transfer(myData.user2, "1"));
    ...
    var test3 = [];
    test3.push(ogdToken.connect(myData.user1Signer).withdrawDividends());
    test3.push(ogdToken.connect(myData.user2Signer).withdrawDividends());
    test3.push(ogdToken.connect(myData.user3Signer).withdrawDividends());
    ...
    var test4 = [];
    test4.push(ogdToken.addDividendToken(fee1Token.address));
    test4.push(ogdToken.addDividendToken(fee2Token.address));
    ...
    test5.push(ogdToken.depositDividend(fee1Token.address, depositFee1Tokens.toFixed(0)));
    test5.push(ogdToken.depositDividend(fee2Token.address, depositFee2Tokens.toFixed(0)));
    ...
    var test6 = [];
    test6.push(ogdToken.connect(myData.user1Signer).withdrawDividends());
    test6.push(ogdToken.connect(myData.user2Signer).withdrawDividends());
    test6.push(ogdToken.connect(myData.user3Signer).withdrawDividends());
    ...
    var test7 = [];
    test7.push(ogdToken.connect(myData.user2Signer).transfer(myData.user3, new BigNumber("0.123456789123456789").shiftedBy(18).toFixed(0)));
